	...
	private void checkCitiesForClick()
	{
		...
		for (Marker marker : cityMarkers) {
			if (!marker.isHidden() && marker.isInside(map, mouseX, mouseY)) {
				...
				String population = (String) marker.getProperty("population");
				for(Marker m : quakeMarkers)
				{
					...
					{
						count++;
						sum = sum + (Float)quakeMarker.getProperty("magnitude");
						avgMag = sum/count;
					}
				}
				System.out.println("Selected city: "+name+"\nCountry: "+country+"\nPopulation: "+population+"\nEarthquakes nearby: "+count);
				System.out.println("Average Magnitude: "+avgMag);
